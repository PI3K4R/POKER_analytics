...
def simulate_hand(
    ...
    if card1[1] == card2[1]:
        ...
        list_of_opps = [(suited_vs_1offsuit, 3), (suited_vs_2offsuit, 'mark_s'), (suited_vs_suited_diff, 3),
                        (suited_vs_suited_sm, 1)]
        ...
        offsuit_vs_2offsuit_sm = [(Card.to_id(c1), Card.to_id(c2)) for c1 in game_deck if c1[1] == "c" for c2 in
                                  game_deck if c2[1] == "d"]

        list_of_opps = [(suited_vs_1offsuit, 2), (offsuit_vs_1offsuit, 4), (suited_vs_2offsuit, 2),
                        (offsuit_vs_2offsuit_diff, 'mark_o'), (offsuit_vs_2offsuit_sm, 1)]
